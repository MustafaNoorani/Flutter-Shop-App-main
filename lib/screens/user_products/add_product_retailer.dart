...
class AddUserProductRetailer extends StatefulWidget {
  const AddUserProductRetailer({Key? key}) : super(key: key);

  @override
  State<AddUserProductRetailer> createState() => _AddUserProductRetailerState();
}

class _AddUserProductRetailerState extends State<AddUserProductRetailer> {
...
//image path, you can get it with image_picker package
  ...
  void _submitForm(String userId,product) {
    ...
    product.add_product(userId,_productName.text,_productPrice.text,_productQuantity.text,_productDescription.text,image,SelectedItem,"r");
